...
export class Tsunade extends Player{
    ...
    initSkills(){
        this.allStates = ["idle","forward","backward","jump","jumpAttack","squat","normalAttack","attacked","die","squatDefense","win","standDefense","mustKill"]
    }
    ...
    initAnimations(){
        ...
        for(let i = 0;i < this.allStates.length;i++){
            let gif = GIF();
            gif.load(`/static/images/player/tsunade/${this.allStates[i]}.gif`)
